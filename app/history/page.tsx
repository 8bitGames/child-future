...
import { getResults, deleteResult, compareResults } from '@/lib/utils/storage';
...
export default function HistoryPage() {
  ...
  const [comparisonResult, setComparisonResult] = useState<ReturnType<typeof compareResults> | null>(null);
  ...
  const handleCompare = () => {
    if (selectedForCompare.length === 2) {
      const result = compareResults(selectedForCompare[0], selectedForCompare[1]);
