...
export default function GoalsPage() {
  ...
  useEffect(() => {
    ...
    setGoals(getChildGoals(id));
    setLoading(false);
  }, [router]);

  const handleCreateGoal = () => {
    if (!childId || !newGoal.title.trim()) return;
    ...
    saveChildGoals(childId, updatedGoals);
            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Link href="/parent" className="inline-block mt-3">
                      ...
                      <div className="flex flex-wrap gap-3 text-xs text-gray-500">
                        ...
                        {goal.targetIBProfile && (
                          <span className="flex items-center gap-1">
                            ...
                            {IB_PROFILE_NAMES[goal.targetIBProfile as IBProfile]}
                          </span>
                        )}
                      </div>
