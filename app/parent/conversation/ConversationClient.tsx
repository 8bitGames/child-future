...
export function ConversationClient() {
  ...
  useEffect(() => {
    ...
    // Load conversation data (child-specific using childId prefix)
    const savedHistory = localStorage.getItem(`child-future-${id}-conversationHistory`);
    const savedFavorites = localStorage.getItem(`child-future-${id}-conversationFavorites`);
    const savedUsedToday = localStorage.getItem(`child-future-${id}-conversationUsedToday`);
    const savedDate = localStorage.getItem(`child-future-${id}-conversationDate`);
    ...
    if (savedDate !== today) {
      ...
      localStorage.setItem(`child-future-${id}-conversationDate`, today);
      localStorage.setItem(`child-future-${id}-conversationUsedToday`, JSON.stringify([]));
      setUsedToday([]);
  ...
  const markAsUsed = () => {
    ...
    localStorage.setItem(`child-future-${childId}-conversationHistory`, JSON.stringify(updatedHistory));
    localStorage.setItem(`child-future-${childId}-conversationUsedToday`, JSON.stringify(updatedUsedToday));
  ...
  const toggleFavorite = (cardId: string) => {
    ...
    localStorage.setItem(`child-future-${childId}-conversationFavorites`, JSON.stringify(updated));
  };
