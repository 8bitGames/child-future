      ...
      <Card className="w-full max-w-md">
        ...
        <div className="px-6 pb-4">
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-2 text-gray-500">아이 로그인</span>
            </div>
          </div>
          ...
          <Link href="/auth/child-login">
            <Button
              type="button"
              variant="outline"
              className="w-full border-2 border-purple-200 hover:bg-purple-50 hover:border-purple-300 text-purple-700"
            >
